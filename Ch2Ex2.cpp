...
no down payment, an interest rate of 18% per year (1.5% per month), and monthly payments of $50.
The monthly payment of $50 is used to pay the interest, and whatever is left is used to pay part
of the remaining debt. Hence, the first month you pay 1.5% of $1,000 in interest. That is $15 in interest.
The remaining $35 is deducted from your debt, which leaves you with a debt of $965.00.
...
int main(int argc, char **argv)
{
  ...
  if(debt - (PAYMENT - (debt * .015)) <= 0)
  {
    ++months;
  }

  cout << "Final number of months: " << months << endl;
